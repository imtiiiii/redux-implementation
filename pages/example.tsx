...
const Example = (props: any) => {
        ...
        <button type="submit" className="_courseporium_social_more_drop_link">
          ...
          >
            <path
              ...
              d="M7.262 2.476h-4.87A1.392 1.392 0 001 3.868v9.74A1.392 1.392 0 002.392 15h9.74a1.391 1.391 0 001.392-1.392v-4.87"
            />
            <path
              stroke="#707070"
              strokeLinecap="round"
              strokeLinejoin="round"
              d="M12.482 1.432a1.476 1.476 0 112.087 2.088l-6.61 6.61-2.783.695.696-2.783 6.61-6.61z"
            />
          </svg>
          <span>Edit</span>
        </button>
  ...
  return (
    <div className="_courseporium_social_top_inner_content">
      <div className="_courseporium_social_top_inner_item _mar_b8">
        <div className="_courseporium_social_top_inner_left">
          <div className="_courseporium_social_top_inner_left_btn">
            <button
              type="submit"
              className="_courseporium_social_top_left_link"
            >
              Web Devlopment
            </button>
          </div>
          <div className="_courseporium_social_top_inner_left_btn">
            <button
              type="submit"
              className="_courseporium_social_top_left_link1"
            >
              Coding
            </button>
          </div>
        ...
        <div className="_courseporium_social_top_inner_right">
          <div className="_courseporium_social_top_inner_right_btn">
            <button
              type="submit"
              className="_courseporium_social_top_right_link"
            >
              <svg
                className="_mar_r6"
                xmlns="http://www.w3.org/2000/svg"
              ...
              >
                <path
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  d="M11 12.25V11a2.5 2.5 0 00-2.5-2.5h-5A2.5 2.5 0 001 11v1.25M6 6a2.5 2.5 0 100-5 2.5 2.5 0 000 5zM14.75 12.25V11a2.5 2.5 0 00-1.875-2.419M10.375 1.081a2.5 2.5 0 010 4.844"
                />
              </svg>
      ...
      <div
        style={{ padding: "20px" }}
        className="_courseporium_social_top_txt sticky"
      >
        <h4 className="_courseporium_social_top_txt_title _titl1 _mar_r28">
          Web Developer Team
        </h4>
        <p className="_courseporium_social_top_txt_para">
          <span>Public</span> . Last post 24 minutes ago
        </p>
      </div>
      <div className="_courseporium_fixed_bar">
        <div
          style={{ padding: "20px" }}
          className="_courseporium_social_top_item_btn _mar_b50"
        >
          <Tabs
            defaultActiveKey="1"
            onChange={callback}
            className="w-100 _social_tab"
          >
            <TabPane style={{ padding: "20px" }} tab="Feed" key="1">
              <Feed />
            </TabPane>
